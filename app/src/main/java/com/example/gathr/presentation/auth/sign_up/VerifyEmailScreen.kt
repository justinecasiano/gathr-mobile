        ...
        Column(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        "Verify your email", modifier = Modifier.fillMaxWidth(), style = TextStyle(
                    ...
                    ResendCodeButton(180, {}, modifier = Modifier.align(Alignment.End))
                }
                BottomButton(
...
//                        0xFF916AD2
//                    ),
                    unfocusedBorderColor = Color(0xFF916AD2),
                    focusedBorderColor = Color(0xFF916AD2),
...
fun ResendCodeButton(
    ...
    TextButton(
        ...
        }, enabled = !isTimerRunning, modifier = modifier
    ) {
